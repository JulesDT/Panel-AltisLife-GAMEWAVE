<div class="container">
      <div class="row">
        ...
        <?php
				if ($search_value == '') {
					$search = $DB->query("SELECT DISTINCT playerid, name, coplevel, donatorlvl, adminlevel, bankacc, cash, bankacc+cash FROM players WHERE donatorlvl = '5' ORDER BY bankacc+cash DESC"); //Affiche les 150 joueurs les plus riches
					}
				else {
