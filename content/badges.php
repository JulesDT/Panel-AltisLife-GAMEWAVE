...
//Compte en banque         
  if(!Auth::isGuest()){
    ...
    echo '<span class="badge" style="width:100px;" data-container="body" data-toggle="popover" data-placement="top" title="'. $pseudo .'" data-content="Banque : masqué | Cash : masqué">argent masqué</span>';  
  }
// Police ou non
if ($coplevel==0){
