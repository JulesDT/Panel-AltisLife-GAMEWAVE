<div class="container">
      <div class="row">
        ...
        <?php
				if ($search_value == '') {
					$search = $DB->query("SELECT playerid, name, coplevel, donatorlvl, adminlevel, bankacc, cash, bankacc+cash FROM players WHERE coplevel = '1' OR coplevel = '2' OR coplevel = '3' OR coplevel = '4' OR coplevel = '5' OR coplevel = '6' OR coplevel = '7' ORDER BY adminlevel DESC"); //Affiche les 150 joueurs les plus riches
					}
				else {
